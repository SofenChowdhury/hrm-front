  ...
  return (
    <div style={styles.container}>
      <div style={styles.cardContainer}>
        ...
        sx={{ cursor: 'pointer' }}>
          <div style={{...styles.circle, ...styles.sickLeaveCircle}}>
            SL
          </div>
          <div style={styles.leaveInfo}>
            <Typography variant="h6" style={styles.leaveTitle}>Sick Leave</Typography>
            <Typography style={styles.leaveText}>Available Leave Days : 10.0</Typography>
            <Typography style={styles.leaveText}>Carryforward Leave Days : 0.0</Typography>
            <Typography style={styles.leaveText}>Total Leave Days : 10.0</Typography>
            <Typography style={styles.leaveText}>Total Leave taken :0</Typography>
          </div>
        </Card>
        ...
        sx={{ cursor: 'pointer' }}>
          ...
          <div style={styles.leaveInfo}>
            <Typography variant="h6" style={styles.leaveTitle}>Casual Leave</Typography>
            <Typography style={styles.leaveText}>Available Leave Days : 1.0</Typography>
            <Typography style={styles.leaveText}>Carryforward Leave Days : 0.0</Typography>
            <Typography style={styles.leaveText}>Total Leave Days : 1.0</Typography>
            <Typography style={styles.leaveText}>Total Leave taken :0</Typography>
          </div>
        </Card>
      </div>
        ...
        <Table>
          <TableHead>
            <TableRow style={styles.tableHeader}>
              ...
              <TableCell style={styles.tableCell} align="right">Actions</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {leaveData.map((row, index) => (
              ...
              sx={{ cursor: 'pointer' }}>
                ...
                <TableCell style={styles.tableCell}>{row.requestedDays}</TableCell>
      ...
      <LeaveRequest isOpen={isModalOpen} toggle={toggleModal} leaveType={selectedLeaveType} />
