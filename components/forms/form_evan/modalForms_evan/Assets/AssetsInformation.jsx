...
const AssetsInformation = ({ open, onClose, assetData, currentIndex, onNavigate, hasPrevious, hasNext }) => {
      ...
      <DialogContent sx={styles.content}>
        ...
        <Box sx={styles.detailsSection}>
          <Box sx={styles.detailItem}>
            ...
            <Typography sx={styles.value}>{assetData?.name || 'N/A'}</Typography>
          </Box>
          <Box sx={styles.detailItem}>
            <Typography sx={styles.label}>Description</Typography>
            <Typography sx={styles.value}>{assetData?.description || 'None'}</Typography>
          </Box>
          <Box sx={styles.detailItem}>
            <Typography sx={styles.label}>Tracking Id</Typography>
            <Typography sx={styles.value}>{assetData?.trackingId || 'N/A'}</Typography>
          </Box>
          <Box sx={styles.detailItem}>
            <Typography sx={styles.label}>Assigned Date</Typography>
            <Typography sx={styles.value}>{assetData?.assignedDate || 'N/A'}</Typography>
          </Box>
          <Box sx={styles.detailItem}>
            <Typography sx={styles.label}>Status</Typography>
            <Typography sx={styles.value}>{assetData?.status || 'N/A'}</Typography>
          </Box>
          <Box sx={styles.detailItem}>
            <Typography sx={styles.label}>Assigned By</Typography>
            <Typography sx={styles.value}>{assetData?.assignedBy || 'N/A'}</Typography>
          </Box>
          <Box sx={styles.detailItem}>
            <Typography sx={styles.label}>Batch No</Typography>
            <Typography sx={styles.value}>{assetData?.batchNo || 'N/A'}</Typography>
          </Box>
          <Box sx={styles.detailItem}>
            <Typography sx={styles.label}>Category</Typography>
            <Typography sx={styles.value}>{assetData?.category || 'N/A'}</Typography>
          </Box>
        </Box>
